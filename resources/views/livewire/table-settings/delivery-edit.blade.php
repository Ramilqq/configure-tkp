<div class="modal fade"  wire:ignore.self id="deliveryModalForm" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="deliveryModalFormLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="deliveryModalFormLabel">@if ($form->id) Изменить @else Создать @endif доставку</h1>
            </div>
