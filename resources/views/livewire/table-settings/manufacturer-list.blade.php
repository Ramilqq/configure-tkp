<div>
    <div class="d-flex align-items-center justify-content-between mb-3 flex-wrap gap-2">
        <h5 class="mb-0 fw-semibold"><i class="bi bi-building me-2 text-success"></i>Производители</h5>
        <button title="Добавить" class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#manufacturerModalForm"
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <button title="Изменить" class="btn btn-outline-primary btn-sm" data-bs-toggle="modal" data-bs-target="#manufacturerModalForm"
