<div class="modal fade"  wire:ignore.self id="industryModalForm" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="industryModalFormLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="industryModalFormLabel">@if ($form->id) Изменить @else Создать @endif отрасль</h1>
            </div>
