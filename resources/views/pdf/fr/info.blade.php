...
<page orientation="portrait" backtop="25mm" backbottom="0mm" backleft="10mm" backright="10mm">
    ...
    @else
    <p>RU-DRIVE VFD – это универсальные преобразователи частоты, предназначенные для управления частотой вращения трехфазных асинхронных и синхронных двигателей мощностью от 200 кВт до 2400кВт и с номинальным напряжением от 3.0 до 11 кВ. Управление частотой вращения электродвигателей осуществляется за счет создания на выходе преобразователя частоты напряжения заданной частоты и амплитуды.</p>
    @endif
