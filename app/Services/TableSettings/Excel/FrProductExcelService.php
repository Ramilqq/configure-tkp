...
class FrProductExcelService
{
    ...
    private const FR_GROUPS = [
        ...
        'power_cell_bypass' => [
            ...
            'variants' => [
                ...
                [
                    'value'     => 'Электронный',
                    'price'     => '[Price_VFD_elecBypass]',
                    'drawing'   => '[Drawing_VFD_elecBypass]',
                    'dimension' => '[Dimension_VFD_elecBypass]',
                    'weight'    => '[VFD_elecBypass_Weight]',
                ],
            ],
        ],
        ...
        'bypass_vfd' => [
            ...
            'variants' => [
                ...
                [
                    'value'     => 'Опция 9',
                    'price'     => '[Price_manbypassVFD]',
                    'drawing'   => '[Drawing_manbypassVFD]',
                    'dimension' => '[Dimension_manbypassVFD]',
                    'weight'    => '[Weight_manbypassVFD]',
                ],
            ],
        ],
    ...
    public function import(string $path, string $sheetName, int $templateId): array
    {
        ...
        DB::transaction(function () use (
            ...
            for ($r = self::DATA_ROW; $r <= $highestRow; $r++) {
                ...
                $fr_hash = $this->makeFrHash($blockId, $blockTitle, $rowByTech);

                $product = $this->findExistingFrProduct($templateId, $fr_hash);
    ...
    private function frHeaderRowValues(): array
    {
        return [
            ...
            40 => 'Опция 2.2: Байпас неисправной силовой ячейки (Электронный)',
            44 => 'Опция 3: Синхронизация на сеть',
            50 => 'Опция 4.1: IP41',
            52 => 'Опция 4.2: IP42',
            54 => 'Опция 5: Предзаряд силовых ячеек',
            59 => 'Опция 6: Серия ВПЧ - Минпромторг',
            61 => 'Опция 7: Тип ЭД - синхронный',
            63 => 'Опция 7.1: Наличие ПЛК управления системой возбуждения',
            64 => 'Опция 8: Байпас ВПЧ (автоматический)',
            68 => 'Опция 9: Байпас ВПЧ (ручной)',
    ...
    private function frLabelRowValues(): array
    {
        return [
            ...
            40 => '[Price_VFD_elecBypass]',
            41 => '[Drawing_VFD_elecBypass]',
            42 => '[VFD_elecBypass_Weight]',
            43 => '[Dimension_VFD_elecBypass]',
            44 => '[Price_SynchrOption]',
            45 => '[Drawing_Reactor]',
            46 => '[Dimension_Reactor]',
            47 => '[Airflow_rate_Reactor]',
            48 => '[Service_Reactor]',
            49 => '[Weight_reactor]',
            50 => '[IP41]',
            51 => '[Price_IP41]',
            ...
            53 => '[Price_IP42]',
            54 => '[Price_PreCharge]',
            55 => '[Drawing_PreCharge]',
            56 => '[Dimension_PreCharge]',
            57 => '[Service_PreCharge]',
            58 => '[Weight_PreCharge]',
            59 => '[VFD_Series (Minprom)]',
            60 => '[VFD_Series_Start (Minprom)]',
            61 => '[Motor_type_Syn]',
            62 => '[Motor_type_full_Syn]',
            63 => '[Price_PLC_Syn]',
            64 => '[Price_bypassVFD]',
            65 => '[Drawing_bypassVFD]',
            66 => '[Dimension_bypassVFD]',
            67 => '[Weight_bypassVFD]',
            68 => '[Price_manbypassVFD]',
            69 => '[Drawing_manbypassVFD]',
            70 => '[Dimension_manbypassVFD]',
            71 => '[Weight_manbypassVFD]',
            72 => '[Profibus_S]',
            73 => '[Profibus]',
            74 => '[Price_Profibus]',
            75 => '[ModbusTCP_S]',
